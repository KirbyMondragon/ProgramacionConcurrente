...
public class coches2Semaforo {
    public static void main(String[] args) {
        ...
        Thread thread1 = new Thread(new Tarea2(semaphore, "Carro 1"));
        Thread thread2 = new Thread(new Tarea2(semaphore, "Carro 2"));
        Thread thread3 = new Thread(new Tarea2(semaphore, "Carro 3"));
...
class Tarea2 implements Runnable {
    ...
    public Tarea2(Semaphore semaphore, String threadName) {
